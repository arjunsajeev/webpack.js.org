...
While loaders are used to transform certain types of modules, plugins can be leveraged to perform a wider range of tasks, like bundle optimization, asset management or injection of environment variables.
